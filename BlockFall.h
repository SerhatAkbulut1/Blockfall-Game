...
public:
    ...
    void print_block(const std::vector<std::vector<bool>> &block);
    vector<vector<bool>> right_rotation(const vector<vector<bool>> &matrix);
    //vector<vector<int>> left_rotation(const vector<vector<int>> &matrix);
